    	...
    	<form:form method="POST" action="formEditPortatil" modelAttribute="portatilModel">
	    	<table>
	    		<tr>
	    			<td>Portátil ID: </td>
	    			<td>
	    				<c:out value="${portatilModel.portatil_id}" />
	    				<form:hidden path="portatil_id" />
	    			</td>
	    			<td>
	    				<c:out value="${portatilModel.portatil_uuid}" />
	    				<c:out value="${portatilModel.portatil_date.getTime()}" />
	    				<c:out value="${portatilModel.portatil_marca}" />
	    				<c:out value="${portatilModel.portatil_modelo}" />
	    			</td>
	    		</tr>
	        	<tr class="mb-3">
	            ...
	            <tr>
	              	<td><input type="submit" class="btn btn-primary" value="Editar Portátil"/></td>
	            </tr>
	        </table>
	  	</form:form> 
    </div>
